#!/usr/bin/env python3
"""
Individual Model Test: Qwen2-7B
Tests Qwen2-7B compatibility with current transformers version
"""
...
class Qwen2Tester:
    """Qwen2-7B compatibility tester"""
    
    def __init__(self):
        self.model_info = model_registry.get_model("qwen2-7b")
        self.model = None
        self.tokenizer = None
        self.config = None
    ...
    def test_config_loading(self):
        ...
        try:
            ...
            # Check Qwen2 specific attributes
            ...
            if missing_attrs:
                return {
                    "status": "fail",
                    "message": f"Missing Qwen2 config attributes: {missing_attrs}",
                    "details": {"config_type": str(type(self.config))}
                }
            
            return {
                "status": "pass",
                "message": "Qwen2 configuration loaded successfully",
                "details": {
            ...
            return {
                "status": "fail",
                "message": f"Qwen2 config loading failed: {str(e)}",
                "error": str(e)
            }
    
    def test_tokenizer_loading(self):
        """Test tokenizer loading and Qwen2-specific functionality"""
        try:
            ...
            return {
                "status": "pass",
                "message": "Qwen2 tokenizer loaded and functioning",
                "details": {
            ...
            return {
                "status": "fail",
                "message": f"Qwen2 tokenizer test failed: {str(e)}",
                "error": str(e)
            }
    
    def test_model_loading(self):
        """Test Qwen2 model loading"""
        try:
            ...
            return {
                "status": "fail",
                "message": f"Qwen2 model loading failed: {str(e)}",
                "error": str(e)
            }
    
    def test_text_generation(self):
        """Test Qwen2 text generation capability"""
        ...
        try:
            ...
            return {
                "status": "pass",
                "message": "Qwen2 text generation successful",
                "details": {
            ...
            return {
                "status": "fail",
                "message": f"Qwen2 generation test failed: {str(e)}",
                "error": str(e)
            }
    
    def test_chat_format(self):
        """Test Qwen2 chat format functionality"""
        ...
        try:
            ...
            if hasattr(self.tokenizer, 'apply_chat_template'):
                ...
                return {
                    "status": "pass",
                    "message": "Qwen2 chat format working",
                    "details": {
...
def run_qwen2_tests():
    """Run all Qwen2-7B tests"""
    print("🚀 Starting Qwen2-7B Compatibility Tests")
    print("=" * 60)
    ...
    if passed == total:
        print("🎉 All tests passed! Qwen2-7B is fully compatible.")
    elif passed + warnings == total:
        print("✅ Tests passed with warnings. Qwen2-7B is mostly compatible.")
    elif passed > 0:
        print("⚠️ Some tests passed. Check individual results.")
    else:
        print("❌ All tests failed. Qwen2-7B is not compatible.")
